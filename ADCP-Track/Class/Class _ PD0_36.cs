...
{
    public class Class_PD0   //  use class Class_PDO.ReadFile   for playback.
    {
        ...
        public enum PacketType { None, FirstLeader, WavesPacket, LastLeader }
        ...
        private void LoadVariable()
        {
            ...
            Record0.EnsembleStruct.BottomTrack.Velocities = new double[4];
            Record0.EnsembleStruct.BottomTrack.RefLayerVelocities = new double[4];

            Record0.PacketStruct.WavesPacketWavesPing.Dist2Surf = new double[4];
            Record0.PacketStruct.WavesPacketWavesPing.Velocity = new double[20];
        ...
        private bool DecodeEnsemble(byte[] TempsRecord0)
        {
            ...
            Record0.EnsembleStruct.Description.EnsembleSize = TempsRecord0.Length;
        ...
        private void DecodeDataBottomTrack(Byte[] ByteIn)
        {
            ...
            Record0.EnsembleStruct.BottomTrack.Velocities = TempInt1;
        ...
        private void DecodeVmDasNavigation(Byte[] ByteIn)
        {
            ...
            Record0.EnsembleStruct.VmDasNavigation.UTC_TIME_OF_LAST_FIX =( ByteIn[22] + ByteIn[23] * 256 + ByteIn[24] * 65536 + ByteIn[25] * 16777216)/10000;
            ...
            Record0.EnsembleStruct.VmDasNavigation.VTG_SPEED_mm_per_sec = (double)(ByteIn[34] + ByteIn[35] * 256) ;
            Record0.EnsembleStruct.VmDasNavigation.VTG_DIRECTION = (double)(ByteIn[36] + ByteIn[37] * 256) * 0.005493164; //0.005493164


            Record0.EnsembleStruct.VmDasNavigation.SPEED_MADE_GOOD = (double)(ByteIn[40] + ByteIn[41] * 256) ;
        ...
        private void DecodeExplorerGGA(Byte[] ByteIn)
        {
            ...
            Record0.EnsembleStruct.ExplorerGGAStruct0.LatMinutes = BitConverter.ToInt32(ByteIn, 24)/1000000000;
            Record0.EnsembleStruct.ExplorerGGAStruct0.LongDegrees = ByteIn[31];
            Record0.EnsembleStruct.ExplorerGGAStruct0.LongMinutes = BitConverter.ToInt32(ByteIn, 32) / 1000000000;
        ...
        private void DecodeExplorerVTG(Byte[] ByteIn)
        {
            ...
            Record0.EnsembleStruct.ExplorerVTGStruct0.SampleTime = BitConverter.ToInt32(ByteIn, 4);
            Record0.EnsembleStruct.ExplorerVTGStruct0.DataAvailable = BitConverter.ToInt32(ByteIn, 8);
            Record0.EnsembleStruct.ExplorerVTGStruct0.ErrorBit0 = BitConverter.ToInt32(ByteIn, 12);
            Record0.EnsembleStruct.ExplorerVTGStruct0.ErrorBit1 = BitConverter.ToInt32(ByteIn, 16);
            Record0.EnsembleStruct.ExplorerVTGStruct0.TrueGroundCourse = BitConverter.ToInt32(ByteIn, 16)/100000;
            Record0.EnsembleStruct.ExplorerVTGStruct0.MagGroundCourse = BitConverter.ToInt32(ByteIn, 16)/100000;
            Record0.EnsembleStruct.ExplorerVTGStruct0.GroundSpeedKnots = BitConverter.ToInt32(ByteIn, 16) / 100000;
            Record0.EnsembleStruct.ExplorerVTGStruct0.GroundSpeedKm = BitConverter.ToInt32(ByteIn, 16) / 100000;
        ...
        {
            Record0.PacketStruct.PacketByte = TempsRecord0;
            ...
            for (int i = 0; i < NumberOfDataType; i++)
            {
                ...
                Record0.PacketStruct.PacketType = PacketType.WavesPacket;

                switch (DataType)
                {
                    case 259://  First leader type
                        Record0.PacketStruct.PacketType = PacketType.FirstLeader;
                        Record0.PacketStruct.WavesPacketLeader=decodeFirstLeader(tempDatatype);
                        //Record0.PacketStruct.WavesPacketLeader=
                        break;
                    case 515:  //  Waves ping
                        Record0.PacketStruct.WavesPacketWavesPing = decodeWavesping(tempDatatype);
                        break;
                    case 771:  //   Last leader
                        Record0.PacketStruct.PacketType = PacketType.LastLeader;
                        Record0.PacketStruct.WavesPacketsLastLeader= decodeWavesLastLeader(tempDatatype);
                        break;
                    case 772:  //   HPR
                        Record0.PacketStruct.WavesPacketsHPR = decodewavesHPR(tempDatatype);
                        break;
                    default:
        ...
        {
            WavesPacketLeaderStruct tempWLStruct = Record0.PacketStruct.WavesPacketLeader;
        ...
        {
            WavesPacketWavesPingStruct TempWaves = Record0.PacketStruct.WavesPacketWavesPing;
        ...
        {
            WavesPacketsHPRStruct TempHPRWaves = Record0.PacketStruct.WavesPacketsHPR;
        ...
        {
            WavesPacketsLastLeaderStruct TempWavesLastLeader = Record0.PacketStruct.WavesPacketsLastLeader;
