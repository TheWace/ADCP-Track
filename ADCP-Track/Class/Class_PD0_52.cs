...
namespace WindowsFormsApplication1
{
    class Class_PD0_52
    {
            ...
            private void Load_Data_Type0()
        {
            ...
            RefDataTypeYesNo0.Add(0x2022, false);     //8226
            ...
            private void AddBufferIN0(byte[] ByteIn)
            {
                ...
                int EnsStart = BufferIn.FindIndex(0, Byte127);
            ...
            private bool ReadFile0(string File_path0)
            {
                try
                {
                    ...
                    if (Get_Record0(0).RecordTypeR == RecordTypeEnum.record){ return true; }
                }
                catch (Exception Ex)
                { 
